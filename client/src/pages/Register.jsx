...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0c14] flex">
        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-[#1a1f2e] p-4 rounded-lg border border-[#2a3042]">
                <span className="text-[#00b3b3] font-medium">Sign Up</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-start justify-center p-8 overflow-y-auto min-h-screen">
        <div className="w-full max-w-md py-8">
          ...
          <p className="text-center text-gray-400 mt-6">
            ...
            <Link to="/login" className="text-[#00b3b3] hover:underline font-medium">
              Login
            </Link>
          </p>
        </div>
